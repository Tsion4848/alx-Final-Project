...
const deskNav = document.querySelector(".header");
...
//function for setting the header transparency when scrolling
...
//Icon SVG template literals to insert when sidebar is open/closed
const menuIcon = `<svg
...
const subjects = [
  ...
  },
  {
    ...
    text: "Teyake.com has been the best resource i have used till now. My students were able to take tests at home, in person and fully online; I wasn't worried about cheating because of the security features provided by the system. I used it mostly with middle school students and they used it with ease. It was also easy to create the tests as i could not use paper as i did in the past. Before i found Teyake.com i used sites that were just not as effective or user friendly. Nothing compares to this.",
  },
];
//inserting all the set values before this into their elements
...
if (!!localStorage.getItem("teachers")) {
  ...
  localStorage.setItem(
    "teachers",
    '[{"username":"tsion","password":"tsion","name":"Tsion Moges","phone":"0909090909","email":"mail@mail.com","institution":"AASTU","id":1,"exams":["ucsLp","5067","ydb7n","t7IYG","mMtI1","P3KOw","kagWd"]},{"username":"kida","password":"kida","name":"Kidus Girma","phone":"0909090909","email":"kida@mail.com","institution":"AASTU","id":2,"exams":["dv9Hb","903","XcKmf"]},{"username":"gragn","password":"gragn","name":"Sonatan Sisay","phone":"0909090909","email":"mail@mail.com","institution":"AASTU","id":3,"exams":[]}]'
  );
}
...
if (!!localStorage.getItem("students")) {
  ...
  localStorage.setItem(
    "students",
    '[{"name":"Fanta","id":"123","email":"fanta@mail.com","examkey":"5067","answers":[1,2,3,1,4,1,1],"marked":[1,0,0,1,0,0,1]},{"name":"Bayu","id":"1234","email":"bayu@mail.com","examkey":"5067","answers":[1,3,4,1,4,4,2],"marked":[1,1,1,1,0,0,0]},{"name":"Kida","id":"12345","email":"kida@mail.com","examkey":"903","answers":[1,4,2,1,3,1],"marked":[0,0,0,0,1,1]},{"name":"abe","id":"123456","email":"abe@mail.com","examkey":"903","answers":[3,4,2,3,3,2],"marked":[0,0,0,0,1,0]},{"name":"Gragn","id":"123","email":"gragn@mail.com","examkey":"903","answers":[1,5,0,4,0,2],"marked":[0,0,0,0,0,0]}]'
  );
}
